						...
						<form method="GET" action="dashboard" name="dashboard" id="dashboard" modelAttribute="dashboard">
								<div class="row">
									<div class="col-md-11 row">
										...
										<div class="col-md-3">
											<div class="form-group">
												<label>View<span style="color: red;"> *</span></label> <select id="view" name="view" class="custom-select" required>
													<option value="">Please Select</option>
										...
										<div class="col-md-3">
											<div class="form-group">
												<label>Financial Year</label> <select id="financialyear" name="financialyear" class="custom-select">
													<option value="">Please Select</option>
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<select id="parameter" name="parameter" class="custom-select" title="Please Select the Parameter">
