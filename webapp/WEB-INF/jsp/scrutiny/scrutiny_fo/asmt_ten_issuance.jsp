...
<div id="caseIdTagLine" style="color: red;display: none;padding-left:0px;padding-top:0px;margin-bottom: 10px;">Please fill caseId.</div>
  <div id="caseStageArnTagLine" style="color: red;display: none;padding-left:0px;padding-top:0px;margin-bottom: 10px;">Please fill case stage arn.</div>
  ...
  <div id="demandCommaSeperatedTagLine" style="color: red;display: none;padding-left:0px;padding-top:0px;margin-bottom: 10px;">Please fill amount without comma seperated.</div>
  ...
  <div id="asmtTenFileAttachTagLine" style="color: red;display: none;padding-left:0px;padding-top:0px;margin-bottom: 10px;">Please attach the file.</div>
  <div id="asmtTenfileMaxSizeTagLine" style="color: red;display: none;padding-left:0px;padding-top:0px;margin-bottom: 10px;">Maximum allowable file size is 10 MB.</div>
  ...
  <h4><b><u>ASMT-10 Issuance:</u></b></h4><br>
    ...
    <div class="row">
            ...
            <div class="col-md-3"  >
				<div class="form-group">
					<label for="asmtTenUploadedFile">File Upload <span style="color: red">*</span></label><span> (upload only pdf file with max file size of 10MB ) </span>
		...
		<input type="hidden" value="" id="asmtCaseReportingDate" name="asmtCaseReportingDate" readonly />
			...
			<div class="col-md-3">
		  <div class="form-group">
		   <label for="recoveryStageArn">Recovery Stage ARN/Reference no<span style="color: red">*</span></label>
