...
<head>
	...
	<title>HP GST | Acknowledgement</title>
...
<body class="hold-transition sidebar-mini">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Acknowledgement Enforcement Cases</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="enforcement_fo/dashboard">Home</a></li>
								<li class="breadcrumb-item active">Acknowledgement Enforcement Cases</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-12">
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Acknowledgement Enforcement Cases List</h3>
								</div>
								<div class="card-body">
											...
											<tbody>
												<c:forEach items="${enforcementCases}" var="object">
													<tr data-gstin="${object.id.GSTIN}" data-period="${object.id.period}" data-reporting-date="${object.id.caseReportingDate}">
														...
														<td style="text-align: center;">
															<button type="button"
																onclick="showCaseIdSubmissionAndApprovalRequestFormTab('${object.id.GSTIN}', '${object.id.period}', '${object.id.caseReportingDate}')"
	...
	<script>
		document.getElementById("category").addEventListener("change", function () {
			...
			var url = "/enforcement_fo/acknowledgement?categoryId=" + selectedValue;
		...
		function showCaseIdSubmissionAndApprovalRequestFormTab(GSTIN, period, caseReportingDate){
			var link = '/enforcement_fo/acknowledge_case?GSTIN='+ GSTIN + '&period=' + period + '&caseReportingDate=' + caseReportingDate;
