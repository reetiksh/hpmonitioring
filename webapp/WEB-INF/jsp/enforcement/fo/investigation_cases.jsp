...
<head>
	...
	<title>HP GST | On Investigation</title>
...
<body class="hold-transition sidebar-mini">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Cases on Investigation</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="enforcement_fo/dashboard">Home</a></li>
								<li class="breadcrumb-item active">On Investigation</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-12">
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Cases on Investigation</h3>
								</div>
								<div class="card-body">
										...
										<table id="example1" class="table table-bordered table-striped">
											<thead>
												<tr>
													...
													<th style="text-align: center; vertical-align: middle;">Assigned on/Last updated (DD-MM-YYYY)
													</th>
	...
	<script>
		document.getElementById("category").addEventListener("change", function () {
			...
			var url = "/enforcement_fo/investigation_cases?categoryId=" + selectedValue;
