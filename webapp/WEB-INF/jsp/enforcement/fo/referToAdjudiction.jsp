...
<script>
  ...
  $('form').on('submit', function(oEvent) {
    ...
    $.confirm({
      title : 'Confirm!',
      content : 'Do you want to proceed ahead with updating Adjudiction details?',
      buttons : {
        submit : function() {
...
<div class="card-body"  style="background-color: #f1f1f1; border-radius: 3px; box-shadow: 2px 2px 4px 1px #8888884d;">
  <p class="h5">Refer To Adjudication</p>
  <hr>
          ...
          <div class="row">
              ...
              <div class="form-group">
                ...
                <select class="form-control selectpicker" data-live-search="true" id="location" name="location" title="Select working location">
                  <c:forEach items="${locationDetailsList}" var="location">
                    <c:if test="${location.locationId eq enforcementCaseDetails.caseLocation.locationId}">
                    ...
                    <c:if test="${location.locationId ne enforcementCaseDetails.caseLocation.locationId}">
            ...
            <!-- <div class="col-lg-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="caseId" name="caseId" placeholder="Please Enter the Case Id" maxlength="15" minlength="15" required/>
              </div>
            </div> -->
          </div>
          <div class="row">
