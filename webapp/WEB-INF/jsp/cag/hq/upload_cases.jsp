					...
					<div class="row">
						<div class="col-md-12">
							<div class="card card-primary">
								...
								<br>
								<div class="col-md-12">
									<a href="/static/files/upload_cag_cases.xlsx" class="btn btn-success" style="float: right;" download><i class="fas fa-download"></i> Sample <i class="fas fa-file-excel"></i></a>
								</div>
								<form method="POST" id="uploadForm" name="uploadForm" modelAttribute="HqUploadForm" action="upload_cases" enctype="multipart/form-data">
									<div class="card-body">
										<div class="row">
											<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
												...
												<div class="col-md-6">
														<div class="form-group">
																...
																<input type="text" class="form-control" value="CAG Param" readonly />
														</div>
...
function submitForm(){
	...
	if(!VerifyUploadSizeIsOK("pdfFile", 104857600)){
		$("#pdf_alert").html("Please upload pdf Within 10MB").css("color","red");
		flag = true;
	}
