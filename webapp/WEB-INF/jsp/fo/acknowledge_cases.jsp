...
<body class="hold-transition sidebar-mini">
								...
								<div class="card-body card">
									...
									<div class="col-md-12">
										<div class="col-md-6 form-group">
											...
											<select id="caseType" name="caseType" class="selectpicker col-md-6"
												data-live-search="true" title="Please Select case type">
												...
												<tr>
													...
													<td>
														<c:if test="${total.uploadedFileName != null}">
															<a href="/fo/downloadUploadedPdfFile?fileName=${total.uploadedFileName}"><button
													...
													<td>
														<c:if test="${total.actionStatus eq 0}">
															<button class="btn btn-primary acknowledgeBtn btn-block"
																data-gstnid="${total.GSTIN_ID}"
																data-reportingdateid="${total.caseReportingDate_ID}"
																data-periodid="${total.period_ID}">Acknowledge</button>
														</c:if>
														...
														<c:if test="${total.auditCase ne 'true'}">
															<button class="btn btn-primary transferBtn btn-block"
																onclick="transferBtn( '${total.GSTIN_ID}' , '${total.caseReportingDate_ID}' , '${total.period_ID}' , '${total.caseId}' );">Transfer</button>
														</c:if>
													</td>
												</tr>
											</c:forEach>
	...
	<script>
		...
		$("#caseType").on('change',function() {
			...
			window.location.href = "/fo/acknowledge_cases?selectedCaseType=" + selectedValue;
		});
