...
$(function() {
  ...
  function amountChange(){
	  ...
	  if(recoveryId == 3 && caseStage == 5){
		   ...
		   $("#recoveryAgainstDemand").prop('readonly', true);
		   $("#recoveryAgainstDemand").val(amount);
	  }
	  else if(recoveryId == 3 && caseStage == 6){
		  
		   $("#recoveryByDRC3").prop('readonly', true);
		   $("#recoveryByDRC3").val(amount);
	  }
  ...
  function notRecovery(){
   ...
   function yetToInitiated(){
	    ...
	    if(actionStatusId == 2 || actionStatusId == 3){
	    	...
	    	$("#caseId").prop("required", true);
	    	$("#caseStageArn").prop("required", true);
	    	$("#recoveryStageArn").prop("required", true);
	    	...
	    	$("#caseId").prop("required", false);
	    	$("#caseStageArn").prop("required", false);
	    	$("#recoveryStageArn").prop("required", false);
...
$('#verifierCaseUpdateForm').on('submit', function(oEvent) {
...
function onAction() {
	...
	<form method="POST" action="fo_update_raised_query_cases" name="caseUpdateForm" id="verifierCaseUpdateForm"  enctype="multipart/form-data" >
		<div class="row">
			<div class="col-md-3">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					<select class="form-control selectpicker" id="actionStatus" name="actionStatus"  onchange="yetToInitiated(),onAction()"  data-live-search="true" title="Please Select" required >
			...
			<div class="col-md-3" id="span5" >
				<div class="form-group">
					...
					<select class="form-control" id="caseStage" name="caseStage"  onchange="caseStageChange()"   data-live-search="true" title="Please Select"  >
		...
		<div class="row" >
		 ...
		 <div class="col-md-3" id="span2">
				<div class="form-group">
					...
					<input class="form-control" type="text" maxlength="11" id="demand" name="demand"  onchange="amountChange()"  onkeypress='return event.charCode >= 48 && event.charCode <= 57'  value="${submittedData.demand}" />
				</div>
			</div>
		   ...
		   <div class="col-md-3">
				...
				<label for="recoveryStage">	Recovery Stage <span style="color: red">*</span></label>  
					<select class="form-control selectpicker recoveryStage" id="recoveryStage" name="recoveryStage" data-live-search="true"  onchange="notRecovery()"  title="Please Select"  >
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					<input class="form-control" type="text" maxlength="11" id="recoveryByDRC3" name="recoveryByDRC3" onkeypress='return event.charCode >= 48 && event.charCode <= 57'  value="${submittedData.recoveryByDRC3}" />
				</div>
			</div>
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					<input class="form-control" type="text" maxlength="11" id="recoveryAgainstDemand" name="recoveryAgainstDemand" onkeypress='return event.charCode >= 48 && event.charCode <= 57'  value="${submittedData.recoveryAgainstDemand}" />
				</div>
			</div>
