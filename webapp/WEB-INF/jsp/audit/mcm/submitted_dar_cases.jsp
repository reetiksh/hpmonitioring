...
<body class="hold-transition sidebar-mini">
												...
												<c:forEach items="${auditCases}" var="object">
													<tr>
														...
														<td style="text-align: center;">
															<button type="button" onclick="window.location.href='/mcm/update_dar_case?tabUrl=${tabUrl}&caseId=${object.caseId}'" class="btn btn-primary"><i class="fas fa-edit"></i></button>
														</td>
													</tr>
												</c:forEach>
											</tbody>
	...
	<script>
		document.getElementById("category").addEventListener("change", function() {
			...
			var url = "/mcm/" + '${tabUrl}' +"?categoryId=" + selectedValue;
