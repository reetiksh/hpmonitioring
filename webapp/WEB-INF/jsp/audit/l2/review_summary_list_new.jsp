                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <c:forEach items="${categoryTotals}" var="total">
                        <tr>
                          <td style="text-align: center; vertical-align: middle;"><a href="/l2/review_cases_list?categoryId=${total[4]}&parameterId=${total[3]}"><c:out value="${total[0]}" /></a></td>
...
document.onkeydown = function (e) {
  ...
  $(document).ready(function () {
    $("#category").change(function(e){
      ...
      window.location.href = '/l2/review_summary_list?categoryId=' + categoryId;
    });

    $("#parameter").change(function(e){
      var parameterId = $(this).val();
      var categoryId = $("#category").val();
      window.location.href = '/l2/review_summary_list?parameterId=' + parameterId + '&categoryId=' + categoryId;
    });
