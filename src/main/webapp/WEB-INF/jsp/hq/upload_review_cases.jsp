        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <br>
              <div class="col-md-12">
                <a href="/static/files/gst_upload_format.xlsx" class="btn btn-success" style="float: right;" download>
                  <i class="fas fa-download"></i> Sample <i class="fas fa-file-excel"></i>
                </a>
              </div>

              <form method="POST" id="uploadForm" name="uploadForm" action="<c:url value='/hq/upload_data' />" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="category" name="category" value="EIU Cases" readonly/>
                      </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <!-- Keep original custom-file markup to preserve existing logic -->
...
<!-- Core: jQuery + Bootstrap 5 bundle + AdminLTE 4 -->
<script src="/static/plugins/jquery/jquery.min.js"></script>
<script src="/static/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<script src="/static/dist/js/adminlte.min.js"></script>

<!-- bs-custom-file-input (kept for your existing file UI logic) -->
...
function submitForm(){
  ...
  var fileInput2 = document.getElementById('excelFile');
  var file2 = fileInput2.files[0];
  if (!validateDocumentType(file2, 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet')) {
    $("#excel_alert").html("Please upload excel sheet").css("color","red");
    flag = true;
  }
...
<script>
function validateDocumentType(file, filetype) { return filetype.includes(file.type); }
</script>
