...
<head>
  ...
  <!-- Keep your existing plugins that the page uses -->
...
<body class="layout-fixed sidebar-expand-lg">
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="card card-body">
            ...
            <!-- default table when viewtype empty -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead style="background-color: #C0C0C0">
                    <tr>
                      <th style="text-align: center; vertical-align: middle;" rowspan="2">Circle</th>
                      <th style="text-align: center; vertical-align: middle;" rowspan="2">No. of Cases</th>
                      <th style="text-align: center; vertical-align: middle;" rowspan="2">Suspected Indicative TaxValue (₹)</th>
                      <th style="text-align: center; vertical-align: middle;" rowspan="2">Demand Created (₹)</th>
                      <th style="text-align: center; vertical-align: middle;" rowspan="2">Amount Recovered (₹)</th>
                      <th style="text-align: center; vertical-align: middle;" rowspan="2">Yet to be Acknowledge</th>
                      <th style="text-align: center; vertical-align: middle;" rowspan="2">Yet to be Initiated</th>
          ...
          <!-- (Your commented-out charts/table remain unchanged) -->
  ...
  <!-- Scripts: jQuery -> Bootstrap 5 -> AdminLTE 4 -> DataTables -> your plugins (logic unchanged) -->
  <script src="https://code.jquery.com/jquery-3.7.1.min.js"></script>
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
  <script src="https://cdn.jsdelivr.net/npm/admin-lte@4.0.0/dist/js/adminlte.min.js"></script>

  <!-- Keep your original plugin scripts that your page logic uses -->
  ...
  <!-- Google Charts (unchanged) -->
  <script>
    google.charts.load('current', { 'packages': ['corechart'] });
    google.charts.setOnLoadCallback(drawChart);
    function drawChart() {
      var data = google.visualization.arrayToDataTable(${indicativeTaxValue});
      var options = { title: 'Category Wise Total Indicative Tax Value', vAxis: { minValue: 0, logScale: true } };
  ...
  <script>
    ...
    function drawChart() {
      ...
      var options = { title: 'Category Wise Total Demand', vAxis: { minValue: 0, logScale: true } };
  ...
  <script>
    ...
    function drawChart() {
      ...
      var options = { title: 'Category Wise Total Recovery', vAxis: { minValue: 0, logScale: true } };
      var chart = new google.visualization.ColumnChart(document.getElementById('pieChart3'));
      chart.draw(data, options);
    }
  </script>

  <!-- Chart.js example (unchanged) -->
  ...
  <!-- DataTables init (unchanged logic) -->
  <script>
  ...
  <!-- FusionCharts example (unchanged) -->
  <script>
    const dataSource = {
    ...
    FusionCharts.ready(function () {
      var myChart = new FusionCharts({ type:"heatmap", renderAt:"chart-container", width:"100%", height:"100%", dataFormat:"json", dataSource }).render();
    });
  </script>
</body>
</html>
