...
<body class="hold-transition sidebar-mini">
						...
						<div class="col-12">
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Pending for Case Assignment</h3>
								</div>
								<div class="card-body">
										...
										<table id="example1" class="table table-bordered table-striped">
											<thead>
												<tr>
													...
													<th style="text-align: center; vertical-align: middle;">Recommended Module</th>
											...
											<tbody>
												<c:forEach items="${auditCases}" var="object">
													<tr>
														...
														<td><c:out value="${object.recommendedModule}" /></td>
			...
			<div class="modal-dialog modal-dialog-centered modal-lg" role="document" >
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="showAssignmentModalTitle">Case Assignment</h5>
	...
	<script>
		document.getElementById("category").addEventListener("change", function() {
			...
			var url = "/l2/case_assignment?categoryId=" + selectedValue;
		...
		function showAssignmentTab(caseId){
			...
			var link = '/l2/recommended_for_other_module/showCaseAssignmentDetailsForRecommendaionModule?caseId=' + caseId;
