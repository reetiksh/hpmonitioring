...
<body class="hold-transition sidebar-mini">
											...
											<tbody>
												<c:forEach items="${auditCases}" var="object">
													<tr>
														...
														<td style="text-align: center;">
															<!-- <button type="button" onclick="window.location.href='/l2/update_dar_case?tabUrl=${tabUrl}&caseId=${object.caseId}'" class="btn btn-primary"><i class="fas fa-edit"></i></button> -->
															<button type="button" onclick="showCaseDetails('${tabUrl}','${object.caseId}')" class="btn btn-primary"><i class="fas fa-edit"></i></button>
														</td>
													</tr>
												</c:forEach>
											</tbody>
	...
	<script>
		document.getElementById("category").addEventListener("change", function() {
			...
			var url = "/l2/" + '${tabUrl}' + "?categoryId=" + selectedValue;
			window.location.href = url;
		});

		function showCaseDetails(tabUrl, caseId) {
			const hidden_form = document.createElement('form'); 
			hidden_form.method = 'get'; 
				
			hidden_form.action = "/l2/show_dar_case_details"; 
				
			const hidden_input1 = document.createElement('input'); 
			hidden_input1.type = 'hidden'; 
			hidden_input1.name = 'tabUrl'; 
			hidden_input1.value = tabUrl; 

			const hidden_input2 = document.createElement('input'); 
			hidden_input2.type = 'hidden'; 
			hidden_input2.name = 'caseId'; 
			hidden_input2.value = caseId; 

			const hidden_input3 = document.createElement('input'); 
			hidden_input3.type = 'hidden'; 
			hidden_input3.name = '${_csrf.parameterName}'; 
			hidden_input3.value = '${_csrf.token}';
