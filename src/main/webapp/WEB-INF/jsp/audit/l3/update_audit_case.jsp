...
<body class="hold-transition sidebar-mini">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Assigned Audit Cases</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="/l3/dashboard">Home</a></li>
								<li class="breadcrumb-item active">Assigned Audit Cases</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-12">
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Assigned Audit Cases</h3>
								</div>
								<div class="card-body">
										...
										<table id="example1" class="table table-bordered table-striped">
											<thead>
												<tr>
													...
													<th style="text-align: center; vertical-align: middle;">Assigned
														on<br>(DD-MM-YYYY)</th>
													<th style="text-align: center; vertical-align: middle;">File Uploaded By
														Headquater</th>
											...
											<tbody>
												<c:forEach items="${auditCases}" var="object">
													<tr>
														...
														<td>
															<c:out value="${object.action.name}" />
														</td>
														<td>
															<c:out value="${object.category.name}" />
														</td>
														<td>
															<c:out value="${object.GSTIN}" />
														</td>
														<td>
															<c:out value="${object.period}" />
														</td>
														<td>
															<fmt:formatDate value="${object.caseReportingDate}" pattern="dd-MM-yyyy" />
														</td>
														<td>
														...
														<td>
															<fmt:formatDate value="${object.assignedDateFromL2ToL3}"
																pattern="dd-MM-yyyy" />
														</td>
														<td style="text-align: center;">
															<c:if test="${not empty object.auditExtensionNoDocument.extensionFileName}">
																<a
																	href="/l3/downloadHqPdfFile?fileName=${object.auditExtensionNoDocument.extensionFileName}">
														...
														<td style="text-align: center;">
															...
															<button type="button" onclick="showCaseDetails('${object.caseId}')"
	...
	<script>
		document.getElementById("category").addEventListener("change", function () {
			...
			var url = "/l3/update_audit_case?categoryId=" + selectedValue;
		...
		function showCaseDetails(caseId) {
			...
			hidden_form.action = "/l3/show_audit_case_details";

			const hidden_input1 = document.createElement('input');
			hidden_input1.type = 'hidden';
			hidden_input1.name = 'caseId';
			hidden_input1.value = caseId;
			...
			$.confirm({
				title: 'Confirm!',
				content: 'Do you want to proceed ahead to view the case details for caseId: ' + caseId + '?',
				buttons: {
					submit: function () {
						hidden_form.submit();
					},
