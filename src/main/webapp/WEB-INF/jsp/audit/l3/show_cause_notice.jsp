...
<script type="text/javascript">
  ...
  $(document).ready(function() {
      ...
      var showCauseWorkingDate = $("#workingDate").val();
      const showCauseWorkingDate1 = new Date(showCauseWorkingDate);
      ...
      } else if (givenDate < showCauseWorkingDate1) {
        $("#workingDateClosureReport").val('');

        var x = document.getElementById("message1");
				if(x.style.display === "none"){
					$("#alertMessage1").html("The closure report date cannot be before " +  formatDate(showCauseWorkingDate1)).css("color","#fffff");
					x.style.display = "block";
					showDiv();
				}
      }
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card-body"  style="background-color: #e9e9e9; border-radius: 3px; box-shadow: 2px 2px 4px 1px #8888884d; margin: 0px 0px 10px 0px;">
          <p class="h5">Show cause notice</p>
          <hr>
            <div class="row">
              <div class="col-lg-12">
                  <div class="row">
