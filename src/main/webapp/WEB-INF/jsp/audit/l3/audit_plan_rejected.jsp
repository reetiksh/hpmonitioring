...
<script>
  ...
  $('form').on('submit', function(oEvent) {
    ...
    $.confirm({
      title : 'Confirm!',
      content : 'Do you want to proceed ahead with resubmission of audit plan details?',
      buttons : {
        submit : function() {
...
<div class="card-body"  style="background-color: #f1f1f1; border-radius: 3px; box-shadow: 2px 2px 4px 1px #8888884d;">
  <p class="h5">Audit Plan Rejected</p>
  <hr>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div id="pdfFileDownloadDiv" style="display: none;">
                <label for="previous_document">Previous Uploaded Document </label><br>
