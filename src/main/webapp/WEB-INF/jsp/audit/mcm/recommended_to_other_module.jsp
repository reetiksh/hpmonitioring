            ...
            <body class="hold-transition sidebar-mini">
                      ...
                      <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                          <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Recommended To Other Modules</li>
                          </ol>
                        </div>
                      </div>
                    </div>
                                    ...
                                    <c:forEach items="${caseList}" var="object">
                                      <tr>
                                        ...
                                        <td style="text-align: center;"><a
                                            href="/mcm/downloadAssessmentHqFile?fileName=${object.fileName}"><button type="button"
              ...
              <script>
                ...
                document.getElementById("category").addEventListener("change", function () {
                  ...
                  var url = "/mcm/recommended_to_other_module?categoryId=" + selectedValue;
