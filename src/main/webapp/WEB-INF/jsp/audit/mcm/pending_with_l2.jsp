...
<body class="hold-transition sidebar-mini">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>MCM consideration (Submittted DAR)</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="/l2/dashboard">Home</a></li>
								<li class="breadcrumb-item active">Verification for DAR</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-12">
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">DAR (Submitted by team lead and allocating officer(s))</h3>
								</div>
								<div class="card-body">
												...
												<c:forEach items="${auditCases}" var="object">
													<tr>
														...
														<td style="text-align: center;">
															<button type="button" onclick="window.location.href='/mcm/update_dar_case?caseId=${object.caseId}'" class="btn btn-primary"><i class="fas fa-edit"></i></button>
														</td>
													</tr>
												</c:forEach>
											</tbody>
	...
	<script>
		document.getElementById("category").addEventListener("change", function() {
			...
			var url = "/mcm/submitted_dar_cases?categoryId=" + selectedValue;
