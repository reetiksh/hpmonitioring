        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="/mcm/review_summary_list">Review Status</a></li>
                  ...
                  <tbody>
                    <c:forEach items="${caseList}" var="object">
                      <tr>
                        ...
                        <td><c:out value="${object.assignTo}" /></td>
                        <td><c:out value="${object.action.name}" /></td>
                        ...
                        <td style="text-align: center;">
                          <c:if test="${not empty object.auditExtensionNoDocument.extensionFileName}">
                              <a href="/mcm/downloadFile?fileName=${object.auditExtensionNoDocument.extensionFileName}">
