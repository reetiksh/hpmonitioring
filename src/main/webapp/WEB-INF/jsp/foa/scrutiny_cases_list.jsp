	...
	<table id="dataListTable" class="table table-bordered table-striped table-responsive">
		...
		<tbody>
			...
			<tr>
				...
				<a href="/fo/downloadUploadedPdfFile?fileName=${item.uploadedFileName}"><button type="button" class="btn btn-primary"><i class="fa fa-download"></i></button></a>
				</c:if>
				</td>
	  ...
	  $.ajax({url: '/checkLoginStatus',
          ...
          async: false,
              success: function(result){
            	  ...
            	  if(result=='true'){
					  $("#updateSummaryViewBody").load('/fo/scrutiny_update_pop_up_view/id?gst='+gst+'&date='+date+'&period='+period, 
