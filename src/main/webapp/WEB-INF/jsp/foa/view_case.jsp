...
<div class="card-body">
	<form method="POST" action="fo_update_cases" name="caseUpdateForm" id="caseUpdateForm"
		enctype="multipart/form-data">
		<div class="row">
			<div class="col-md-3">
				<div class="form-group">
					<label for="gstin">GSTIN </label>
					<input class="form-control" id="gstin" name="GSTIN_ID" value="${viewItem.GSTIN_ID}" name="gstin"
						readonly />
				</div>
			</div>
			<div class="col-md-3">
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					<input class="form-control" id="circle" name="circle" value="${viewItem.circle}" name="circle"
						readonly />
				</div>
			</div>
			<div class="col-md-3">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					<input class="form-control" value="<fmt:formatDate value='${viewItem.date}' pattern='dd-MM-yyyy' />"
						readonly />
				</div>
			</div>
			<input type="hidden" class="form-control" id="caseReportingDate" value="${viewItem.caseReportingDate_ID}"
				name="caseReportingDate_ID" />
			<input type="hidden" name="period_ID" value="${viewItem.period_ID}">
			<div class="col-md-3">
				<div class="form-group">
					<label for="suspectedIndicative">Indicative Value(₹)</label>
					<input class="form-control" id="susIndicativeTax" value="${viewItem.indicativeTaxValue}"
						name="indicativeTaxValue" readonly />
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-group">
		...
		<div class="row">
			<div class="col-md-3">
				<div class="form-group">
					...
					<select class="form-control selectpicker" id="actionStatus" name="actionStatus"
						onchange="yetToInitiated(),onAction()" data-live-search="true" title="Please select Action Status"
						required>
						<option data-tokens="actionstatus" value="0" disabled>Select</option>
						<c:forEach items="${listActionStatus}" var="categories">
							<option data-tokens="" value="${categories.id}" <c:if
								test="${categories.id == submittedData.actionStatus}"> selected </c:if> >${categories.name}
							</option>
						</c:forEach>
					</select>
				</div>
			...
			<div class="col-md-3" id="span5">
				<div class="form-group">
					...
					<select class="form-control" id="caseStage" name="caseStage" onchange="caseStageChange()"
			...
			<div class="row">
					...
					<div class="form-group">
						...
						<select class="form-control selectpicker recoveryStage" id="recoveryStage" name="recoveryStage"
							...
							<c:forEach items="${listRecovery}" var="categories">
								<option data-tokens="" value="${categories.id}" <c:if test="${categories.id == '4'}">disabled
									</c:if>
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<input class="form-control" type="text" maxlength="11" id="recoveryAgainstDemand"
							name="recoveryAgainstDemand" onkeypress='return event.charCode >= 48 && event.charCode <= 57'
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<c:if test="${submittedData.sum eq 'fileexist'}">
							<a href="/foa/downloadUploadedFile?fileName=${submittedData.remarks}"><button type="button"
