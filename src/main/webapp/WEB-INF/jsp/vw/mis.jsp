...
<head>
  ...
  <!-- AdminLTE 4 / Bootstrap 5 compatible assets (paths unchanged) -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">
  <link rel="stylesheet" href="/static/plugins/fontawesome-free/css/all.min.css">
  <link rel="stylesheet" href="/static/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
  <link rel="stylesheet" href="/static/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
...
<div class="app-wrapper">
  ...
  <!-- Header / Sidebar (keep includes exactly as used) -->
  <jsp:include page="../layout/header.jsp"/>
  <jsp:include page="../layout/sidebar.jsp"/>

  <!-- ====================== MAIN (AdminLTE 4 structure) ====================== -->
  <main class="app-main">
    <div class="app-content">
      <div class="container-fluid">
        ...
        <div class="content-header">
          <div class="row mb-2">
            <div class="col-sm-6"><h1 class="m-0">MIS</h1></div>
        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            ...
            <div class="dropdown">
              <button class="btn btn-primary dropdown-toggle px-5"
                      type="button"
