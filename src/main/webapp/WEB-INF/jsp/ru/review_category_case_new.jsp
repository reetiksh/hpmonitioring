                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <c:forEach items="${categoryTotals}" var="total">
                        <tr>
                          <td style="text-align: center; vertical-align: middle;"><a href="/ru/view_list_of_case?category=${total[0]}&parameterId=${total[7]}"><c:out value="${total[0]}" /></a></td>
...
document.onkeydown = function (e) {
  ...
  $(document).ready(function () {
    $("#category").change(function(e){
      ...
      window.location.href = '/ru/review_category_case?categoryId=' + categoryId;
    });

    $("#parameter").change(function(e){
      var parameterId = $(this).val();
      var categoryId = $("#category").val();
      window.location.href = '/ru/review_category_case?parameterId=' + parameterId + '&categoryId=' + categoryId;
    });
