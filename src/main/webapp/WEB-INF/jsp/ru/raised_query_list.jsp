    ...
    <div class="app-content">
      <div class="container-fluid">
        ...
        <div class="content-header">
          <div class="row mb-2">
            <div class="col-sm-6"><h1 class="m-0">Raised Query</h1></div>
            <div class="col-sm-6 d-flex justify-content-end">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/ru/dashboard">Home</a></li>
                <li class="breadcrumb-item active">Raised Query</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="card card-primary">
          <div class="card-header"><h3 class="card-title mb-0">Raised Query</h3></div>
