...
<head>
  ...
  <!-- DataTables Bootstrap 5 (CDN). If you prefer local files, swap to your /static paths -->
      ...
      <div class="container-fluid">
        ...
        <section class="content-header px-0">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>
                <a href="review_category_case?categoryId=${categoryId}" class="btn btn-primary">
                        ...
                        <tr>
                          ...
                          <td style="text-align:center;">
                            <c:if test="${not empty object[18]}">
                              <a href="/ru/downloadFile?fileName=${object[18]}">
...
<script>
  // Preserve your existing guard logic (unchanged)
  ...
  // DataTables init (same options you used)
  $(function () {
    $("#example1").DataTable({
      responsive: false,
      lengthChange: false,
...
<!-- (Kept as-is, even though it expects JSON; no logic changes) -->
<script>
