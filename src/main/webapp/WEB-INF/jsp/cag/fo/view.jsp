                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <c:forEach items="${categoryTotals}" var="total">
                        <tr>
                          <td style="text-align: center; vertical-align: middle;"><a href="/cag_fo/view_list_of_case?parameter=${total[0]}"><c:out value="${total[0]}" /></a></td>
                          <td style="text-align: center; vertical-align: middle;"><c:out value="${total[1]}" /></td>
                          <td style="text-align: center; vertical-align: middle;"><fmt:formatNumber value="${total[2]}" pattern="#,##,##0"/></td>
                        </tr>
                      </c:forEach>
                    </tbody>
                  </table>
