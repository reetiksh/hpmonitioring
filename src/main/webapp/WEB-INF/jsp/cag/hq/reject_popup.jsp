  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="rejectModalTitle">Reject</h5>
        <button type="button" class="close"  data-dismiss="modal" aria-label="Close">    
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      
      <form method="POST" name="rejectForm" id="rejectForm" action="reject_transfer_cases"  >
      <div class="modal-body">
       
          <input type="hidden" id="gstno" name="gstno" >
          <input type="hidden" id="date" name="date" >
          <input type="hidden" id="period_id" name="period" >
          <input type="hidden" id="parameter" name="parameter" >
          <input type="hidden" id="jurisdiction" name="caseAssignedTo" >
