...
<head>
	...
	<title>HP GST | Permission Required</title>
...
<body class="hold-transition sidebar-mini">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Permission Required Cases</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="enforcement_svo/dashboard">Home</a></li>
								<li class="breadcrumb-item active">Permission for Investigation</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-12">
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Permission Required For Investigation</h3>
								</div>
								<div class="card-body">
													...
													<tr data-gstin="${object.id.GSTIN}" data-period="${object.id.period}" data-reporting-date="${object.id.caseReportingDate}">
														...
														<td style="text-align: center;">
															<c:if test="${not empty object.extensionNoDocumentId.extensionFileName}">
																<a
																	href="/enforcement_svo/downloadHqPdfFile?fileName=${object.extensionNoDocumentId.extensionFileName}">
	...
	<script>
		document.getElementById("category").addEventListener("change", function () {
			...
			var url = "/enforcement_svo/update_enforcement_cases?categoryId=" + selectedValue;
		...
		function showCaseIdSubmissionAndApprovalRequestFormTab(GSTIN, period, caseReportingDate){
			var link = '/enforcement_fo/caseIdSubmissionAndApprovalRequest?GSTIN='+ GSTIN + '&period=' + period + '&caseReportingDate=' + caseReportingDate;
