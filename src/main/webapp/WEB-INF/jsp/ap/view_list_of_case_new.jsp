  ...
  <main class="app-main">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><a href="review_category_case?categoryId=${categoryId}" class="btn btn-primary"><i class="fas fa-arrow-left nav-icon"></i></a> Review Case Summary</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/ap/dashboard">Home</a></li>
              <li class="breadcrumb-item"><a href="/ap/review_category_case">Review Status</a></li>
                      ...
                      <tr>
                        ...
                        <td style="text-align: center;">
                          <c:if test="${not empty object[18]}">
                              <a href="/ap/downloadFile?fileName=${object[18]}">
