...
<body class="hold-transition sidebar-mini">
									...
									<table id="example1" class="table table-bordered table-striped">
										<thead>
											<tr>
												...
												<th style="text-align: center; vertical-align: middle;">ASMT-10 Required?</th>
												...
												<tr>
													...
													<c:choose>
													    <c:when test="${not remarksIsEmpty}">
													        ...
													        <c:forEach items="${mstScrutinyCase.verifierRemarks}" var="remark" varStatus="loop">
													...
													<c:if test="${not empty mstScrutinyCase.verifierRemarks}">
													...
													<td style="text-align: center; vertical-align: middle;"><c:if test="${mstScrutinyCase.scrutinyExtensionNoDocument.id != null}">
													...
													<td style="text-align: center; vertical-align: middle;">
														<button class="btn btn-primary" onclick="scrutinyInitiated('${mstScrutinyCase.id.GSTIN}' , '${mstScrutinyCase.id.caseReportingDate}' , '${mstScrutinyCase.id.period}');">Yes</button>														
														<button class="btn btn-primary transferBtn" onclick="scrutinyProceedingDropped('${mstScrutinyCase.id.GSTIN}' , '${mstScrutinyCase.id.caseReportingDate}' , '${mstScrutinyCase.id.period}' , '${mstScrutinyCase.taxpayerName}' , '${mstScrutinyCase.locationDetails.locationName}' , '${mstScrutinyCase.category.name}' , '${mstScrutinyCase.indicativeTaxValue}');">No</button>
													</td>
												</tr>
											</c:forEach>
										</tbody>
	...
	<script>
		...
		function scrutinyInitiated(gstin,reportingDate,period){
			var url = '/scrutiny_fo/scrutiny_initiated?gstin=' + gstin +"&reportingDate=" + reportingDate + "&period=" + period;
		...
		function scrutinyProceedingDropped(gstno, date, period, taxpayerName, locationName, category, indicativeTaxValue) {
			...
			$("#scrutinyProceedingDroppedModal").modal('show');
		}
	</script>
	...
	<script>
										        	...
										        	if (remarkOptions == 2) {
										        		...
										        		$.ajax({
															...
															success : function(result) {
																...
																$("#scrutinyProceedingDroppedModal").modal('hide');
																$.alert(result);
		...
		$('#scrutinyProceedingDroppedModal').on('hidden.bs.modal', function () {
