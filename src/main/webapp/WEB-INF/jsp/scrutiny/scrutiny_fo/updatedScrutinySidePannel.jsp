  ...
  <c:choose>
    <c:when test="${status.id eq '6'}">
      <button type="button"
              ...
              style="border-radius: 0px 150px 150px 0px; margin-bottom: 5px; width: 250px;"
              onclick="displayDynamicSidePannelView('${status.id}')">
        ${status.name}
      </button>
    </c:when>
    <c:otherwise>
      <button type="button"
              ...
              style="border-radius: 0px 150px 150px 0px; margin-bottom: 5px; width: 250px; text-align: center;"
              onclick="displayDynamicSidePannelView('${status.id}')">
        ${status.name}
      </button>
    </c:otherwise>
