					...
					<div class="row">
						<div class="col-md-12">
							<div class="card card-primary">
								...
								<br>
								<div class="col-md-12">
									<a href="/static/files/upload_scrutiny_cases.xlsx" class="btn btn-success" style="float: right;" download><i class="fas fa-download"></i> Sample <i class="fas fa-file-excel"></i></a>
								</div>
								<form method="POST" id="uploadScrutinyForm" name="uploadScrutinyForm" action="<c:url value='/scrutiny_hq/upload_cases' />" enctype="multipart/form-data">
									<div class="card-body">
										<div class="row">
...
<script>
	...
	$(document).ready(function(){
	    $(document).on('click', '.sampleExcel', function(event){
	        event.preventDefault();

	        // Make an AJAX call to update the Excel file
	        $.ajax({
	            ...
	            success: function() {
	                // Once the update is complete, trigger the download
	                var fileName = 'upload_scrutiny_cases.xlsx'; 
	                var downloadUrl = '/scrutiny_hq/downloadUpdatedExcel?fileName=' + encodeURIComponent(fileName);
