	...
	<table id="scrutinyListTable" class="table table-bordered table-striped table-responsive">
		...
		<tbody>
			...
			<tr>
				...
				<td>
				<a href="/scrutiny_hq/downloadUploadedPdfFile?fileName=${mstScrutinyCase.scrutinyExtensionNoDocument.extensionFileName}"><button type="button" class="btn btn-primary"><i class="fa fa-download"></i></button></a>
				</td>
