...
<head>
  ...
  <title>Recommended From HQ User</title>
...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <jsp:include page="../scrutiny_ru/recommended_from_hq_user_pop_up.jsp" />
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Recommended From HQ User</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="/ap/dashboard">Home</a></li>
                <li class="breadcrumb-item active">Recommended From HQ User</li>
              </ol>
            </div>
          </div>
        </div>
            ...
            <div class="col-12">
              <div class="card-primary">
                <div class="card-header">
                  <h3 class="card-title">Recommended From HQ User</h3>
                </div>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <th style="text-align: center; vertical-align: middle;">HQ Remarks</th>
                    ...
                    <tbody>
                      <c:forEach items="${mstScrutinyCasesList}" var="object" varStatus="loop">
                        <tr>
                          ...
                          <td style="text-align: center; vertical-align: middle;">
                            <c:out value="${object.indicativeTaxValue}" />
                          </td>
                          <td style="text-align: center; vertical-align: middle;">
                            <c:out value="${object.category.name}" />
                          </td>
                          <td style="text-align: center; vertical-align: middle;">
                            <c:out value="${object.amountRecovered}" />
                          </td>
                          <td style="text-align: center; vertical-align: middle;">
                          ...
                          <td style="text-align: center; vertical-align: middle;">
                            <c:out value="${object.recoveryByDRC03}" />
                          </td>

                          <td>
                            <c:forEach items="${object.hqRemarks}" var="remark" varStatus="loop">
                          ...
                          <td style="text-align: center; vertical-align: middle;">
                            <button type="button"
                              ...
                              class="btn btn-primary" id="appealRevisioinRejectBtn">Recommend</button>
                          </td>
                        </tr>
                      </c:forEach>
                    </tbody>
