...
function onAction() {
	...
	<form method="POST" action="fo_update_raised_query_recovery_cases" name="caseUpdateForm" id="caseUpdateForm" enctype="multipart/form-data" >
		<div class="row">
			<div class="col-md-3">
		...
		<div class="row" >
		    ...
		    <div class="col-md-3">
				<div class="form-group">
				<label for="recoveryStage">	Recovery Stage </label>  
