  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Update Recovery Status</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a>Home</a></li>
              <li class="breadcrumb-item active">Update Recovery Status</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-12">
            <div class="card-primary">
              <div class="card-header">
                <h3 class="card-title">Update Recovery Status</h3>
              </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <c:if test="${formResult.hasFieldErrors('category')}">
                      <span class="text-danger" style="color:red;">${formResult.getFieldError('category').defaultMessage}</span>
                    </c:if>
                  </div>
                </div>
...
<script>
  // Basic hardening (unchanged behavior)
  ...
  $(document).ready(function(){
    ...
    // Flash messages fade
    $("#message").fadeTo(2000, 500).slideUp(500, function(){ $(this).slideUp(500); });
  });
...
<script>
  // Form/file validation helper (kept same)
...
<script>
  // Category change -> guarded load (logic unchanged)
  $(function(){
      ...
      $.ajax({
        ...
        success: function(result){
          ...
          if (result == 'true') {
            ...
            $("#loader").show();
            setTimeout(function(){
              $("#dataListDiv").load('/fo/update_summary_recovery_data_list/' + selectedValue + '/', function(response, status){
                $("#loader").hide();
                if (status == 'success') {
                  console.log("success");
                } else {
