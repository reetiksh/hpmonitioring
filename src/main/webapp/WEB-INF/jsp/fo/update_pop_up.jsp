...
<head>
  <meta charset="utf-8">
  <title>FO | Update Scrutiny Case</title>
  <meta name="viewport" content="width=device-width, initial-scale=1">

  <!-- Styles (kept minimal; same libraries you already use elsewhere) -->
  <link rel="stylesheet" href="/static/plugins/fontawesome-free/css/all.min.css">
  <link rel="stylesheet" href="/static/dist/css/adminlte.min.css">
  <link rel="stylesheet" href="/static/dist/css/bootstrap-select.min.css">
  <link rel="stylesheet" href="/static/dist/css/jquery-confirm.min.css">

  <!-- Ensure jQuery/Bootstrap are available BEFORE inline scripts below -->
...
<div class="wrapper">
  ...
  <!-- (Optional) header/sidebar includes
...
<%-- =================== YOUR ORIGINAL CONTENT STARTS (logic unchanged) =================== --%>
<style>
  .btn-outline-custom {
    color: #495057;
		...
		<div class="col-md-3" id="span4">
			<div class="form-group">
			    ...
			    <c:if test="${viewItem.caseIdUpdated eq 'no'}">
			      <input class="form-control" id="caseId" name="caseId" value="${viewItem.caseId}"  placeholder="Please enter Case Id" maxlength="15" pattern="[A-Za-z0-9]{15}" title="Please enter 15-digits alphanumeric Case Id"  />
			    </c:if>
			</div>
		</div>
