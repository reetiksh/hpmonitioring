	...
	<form method="POST" action="fo_update_scrutiny_cases" name="caseUpdateForm" id="caseUpdateForm" enctype="multipart/form-data">
		...
		<div class="col-md-3" id="span4"  >
				<div class="form-group">
				    ...
				    <input class="form-control" id="caseId" name="caseId" value="${viewItem.caseId}"  placeholder="${viewItem.caseId != null ? viewItem.caseId : 'Please enter Case Id'}" maxlength="15" pattern="[A-Za-z0-9]{15}" title="Please enter 15-digits alphanumeric Case Id"  /> 
				    <input class="form-control" value="${viewItem.caseId}" />
				    </c:if> --%>
 			...
 			<div class="col-md-3" id="span5"  >
				<div class="form-group">
					...
					<select class="form-control" id="caseStage" name="caseStage"  onchange="caseStageChange()"  title="Please select Case Stage"  >
