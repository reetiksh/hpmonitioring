...
function onAction() {
	...
	<form method="POST" action="fo_update_reject_cases" name="caseUpdateForm" id="approverCaseUpdateForm" enctype="multipart/form-data" >
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="form-group">
					<label for="message-text" >Period</label>
		...
		<div class="col-md-3" id="span2">
				<div class="form-group">
					...
					<input class="form-control" type="text" maxlength="11" id="demand" name="demand" onchange="amountChange()"  value="${submittedData.demand}"  onkeypress='return event.charCode >= 48 && event.charCode <= 57'  />
				</div>
		</div>
		...
		<div class="col-md-3">
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					<input class="form-control" type="text" maxlength="11" id="recoveryByDRC3" name="recoveryByDRC3"  value="${submittedData.recoveryByDRC3}"  onkeypress='return event.charCode >= 48 && event.charCode <= 57'  />
				</div>
			</div>
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					<input class="form-control" type="text" maxlength="11" id="recoveryAgainstDemand" name="recoveryAgainstDemand"  value="${submittedData.recoveryAgainstDemand}"  onkeypress='return event.charCode >= 48 && event.charCode <= 57'  />
				</div>
	        </div>
