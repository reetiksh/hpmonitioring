					...
					<div class="row">
						<div class="col-md-12">
							<div class="card card-primary">
								...
								<form method="POST" id="uploadSelfDetectedCaseForm" name="uploadSelfDetectedCaseForm" action="/fo/self_detected_cases" enctype="multipart/form-data" modelAttribute="selfDetectedCase">
									<div class="card-body">
										<div class="row">
