  ...
  $(document).ready(function () {
    ...
    $.ajax({
      ...
      success: function (result) {
        $('#caseStage').empty().append('<option value="" disabled selected>Select</option>');
        $.each(result, function (key, value) {
          var sel = (key == ${submittedData.caseStage}) ? 'selected' : '';
          $('#caseStage').append('<option value="' + key + '" ' + sel + '>' + value + '</option>');
        });
      }
    });

    // initial readonly toggles
    ...
    if (actionId < actionStatus) {
      ...
      $.ajax({
        ...
        success: function (result) {
          $('#caseStage').empty().append('<option value="" disabled selected>Select</option>');
          $.each(result, function (key, value) {
            var sel = (key == caseStage) ? 'selected' : '';
            $('#caseStage').append('<option value="' + key + '" ' + sel + '>' + value + '</option>');
          });
        }
      });
  ...
  <form method="POST" action="fo_update_scrutiny_cases" name="caseUpdateForm" id="caseUpdateForm" enctype="multipart/form-data">
    ...
    <div class="row">
      <div class="col-md-3">
        <div class="form-group">
          <label>Period</label>
          <input class="form-control" name="period_ID_readonly" value="${viewItem.period_ID}" readonly />
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="form-group">
          <label for="actionStatus">Action Status <span class="text-danger">*</span></label>
      ...
      <div class="col-md-3" id="span5">
        <div class="form-group">
          <label for="caseStage">Case Stage <span class="text-danger">*</span></label>
      ...
      <div class="col-md-3" id="span6">
        <div class="form-group">
          <label for="caseStageArn">Case Stage ARN/Reference no <span class="text-danger">*</span></label>
    ...
    <!-- Wrapper that can be shown/hidden as a whole -->
    <div id="span1">
      <div class="row">
        <!-- Amount -->
        <div class="col-md-3" id="span2">
          <div class="form-group">
            <label for="demand">Amount (₹) <span class="text-danger">*</span></label>
        ...
        <div class="col-md-3">
          <div class="form-group">
            <label for="recoveryByDRC3">Recovery Via DRC03 (₹) <span class="text-danger">*</span></label>
        ...
        <div class="col-md-3">
          <div class="form-group">
            <label for="uploadedFile">File Upload <span class="text-danger">*</span></label>
